  ...
  renderDefaultCircle() {
    ...
    return (
      <CircularSlider
        ...
        startIcon={<G transform={{ translate: '-7, -7' }}>{BEDTIME_ICON}</G>}
        stopIcon={<G transform={{ translate: '-7, -7' }}>{WAKETIME_ICON}</G>}
      />
    );
  }
  ...
  renderUserCircle() {
    ...
    return (
      <CircularSlider
        ...
        clockFaceColor="#9d9d9d"
        bgCircleColor="#D81C5F"
        startIcon={<G transform={{ translate: '-10, -10' }}>{BEDTIME_ICON}</G>}
        stopIcon={<G transform={{ translate: '-13.5, -13.5' }}>{WAKETIME_ICON}</G>}
      />
    );
  }
